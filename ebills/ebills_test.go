...
const mockResponse = `{
	"data": {
		"id": "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxx111",
		"type": "ebills",
		"attributes": {
			"status": "send",
...
func setupUnauthorizedServer() *httptest.Server {
	return httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("X-Request-Id", "requestx-yyyy-yyyy-yyyy-yyyyyyyyy112")
...
func setupEbill(apiBaseURL string) *ebills.Ebills {
	...
	return ebills.NewEbills("testxxxx-xxxx-xxxx-xxxx-xxxxxxxxx111", apiRequestor)
}

func TestGetDetails(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		assert.Equal(t, "/organisations/testxxxx-xxxx-xxxx-xxxx-xxxxxxxxx111/deliveries/ebills/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxx111", r.URL.Path)
	...
	resp, err := ebillClient.GetDetails("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxx111", params, headers)
...
func TestGetDetails_Error(t *testing.T) {
	...
	params := map[string]string{}
	headers := map[string]string{}
	_, err := ebillClient.GetDetails("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxx111", params, headers)
...
func TestGetCollection(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		assert.Equal(t, "/organisations/testxxxx-xxxx-xxxx-xxxx-xxxxxxxxx111/deliveries/ebills", r.URL.Path)
		assert.Equal(t, http.MethodGet, r.Method)
	...
	params := map[string]string{}
	headers := map[string]string{}
	resp, err := ebillClient.GetCollection(params, headers)
...
func TestGetCollection_Error(t *testing.T) {
	...
	params := map[string]string{}
	headers := map[string]string{}
	_, err := ebillClient.GetCollection(params, headers)
